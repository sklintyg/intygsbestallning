...
import IntygsskolaLink from '../../styles/IntygsskolaLink'
    ...
    <Fragment>
      ...
      <Modal isOpen={isOpen} size={'lg'} backdrop={true} toggle={handleClose}>
        ...
        <ModalBody>
          ...
          <p>
            För att kunna generera utskrifter använder sig Intygbeställning av{' '}
            <ExternalLink href="https://itextpdf.com">iText7</ExternalLink>. För mer information under vilka villkor iText7 får användas läs
