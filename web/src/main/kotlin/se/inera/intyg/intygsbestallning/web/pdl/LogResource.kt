...
class LogResource private constructor(builder: LogResource.Builder) {
     ...
     */
    (val patientId: String, val enhetsId: String, val vardgivareId: String) {
