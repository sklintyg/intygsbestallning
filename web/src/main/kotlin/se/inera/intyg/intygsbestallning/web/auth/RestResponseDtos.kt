...
data class SessionState(
   val isHasSession: Boolean = false,
   val isAuthenticated: Boolean = false,
   val secondsUntilExpire: Long = 0
)

data class GetSessionStatResponse(
   val sessionState: SessionState,
   val statResponse: StatResponse? = null
)

data class GetAppConfigResponse(
